...
public class Data_access_object {
	...
	public static List<Customers_Order_And_Item_dto> 	CustomersOrderAndItemTask() throws ClassNotFoundException, SQLException {
		Connection connection = dp.getConnection();
		  String sql = "SELECT b.id,d.item_name,d.item_sku,d.item_rate,d.ordered_qty,d.order_total,b.order_no,b.payment_type,b.order_date,b.delivery_date"
				    + " FROM tb_madha_customer_order b"
				    + " JOIN tb_madha_customer_order_item d  ON d.order_id= b.id WHERE b.id LIMIT 5";	
        		PreparedStatement preparedStatement = connection.prepareStatement(sql);
		ResultSet resultSet = preparedStatement.executeQuery();
		...
		while(resultSet.next()) {
			...
			String item_sku=resultSet.getString(3);
			String item_rate=resultSet.getString(4);
			String ordered_qty=resultSet.getString(5);
			String order_total=resultSet.getString(6);
			String order_no=resultSet.getString(7);
			String payment_type=resultSet.getString(8);
			String order_date=resultSet.getString(9);
			String delivery_date=resultSet.getString(10);
		
			
			
			Customers_Order_And_Item_dto object=new Customers_Order_And_Item_dto(id,item_name,item_sku,item_rate,ordered_qty,order_total,order_no,payment_type,order_date,delivery_date);
			user.add(object);
